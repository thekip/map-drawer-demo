...
DirectSelect.toDisplayFeatures = function(state, geojson, push) {
  if (state.featureId === geojson.properties.id) {
    ...
    push(geojson);
    //createSupplementaryPoints(state.feature.toGeoJSON(), {

    const origFeature = JSON.parse(JSON.stringify(geojson));
    origFeature.geometry = state.feature.toGeoJSON().geometry;


    const points = createSupplementaryPoints(origFeature, {
      map: this.map,
      //midpoints: true,
